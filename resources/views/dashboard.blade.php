<x-app-layout>
    <meta name="user-role" content="{{ auth()->user()->role ?? 'cashier' }}">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4" id="cashier-actions" style="display: none;">
                            ...
                            <a href="{{ route('sales.create') }}" class="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
                            ...
                            <a href="{{ route('products.index') }}" class="flex items-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors">
                            ...
                            <a href="{{ route('customers.create') }}" class="flex items-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors">
                        ...
                        <div class="grid grid-cols-2 gap-4" id="admin-actions" style="display: none;">
                            <a href="{{ route('categories.create') }}" class="flex items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
                            ...
                            <a href="{{ route('products.create') }}" class="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
                            ...
                            <a href="{{ route('purchases.create') }}" class="flex items-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors">
