    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Create a new promotional campaign for your products</p>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Enter the basic details of your promotion</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" 
                                ...
                                <option value="bundle" {{ old('type') == 'bundle' ? 'selected' : '' }}>Bundle Deal</option>
                                ...
                                <option value="seasonal" {{ old('type') == 'seasonal' ? 'selected' : '' }}>Seasonal Event</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" 
                                      ...
                                      class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-gray-200 transition-all">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
...
<!-- Target & Schedule Section - UPDATED -->
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
    <div class="flex items-center mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
            ...
            <select name="target_type" 
                    ...
                    required
                    class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-gray-200 transition-all">
                <option value="all" {{ old('target_type') == 'all' ? 'selected' : '' }}>All Products</option>
                <option value="specific_products" {{ old('target_type') == 'specific_products' ? 'selected' : '' }}>Specific Products</option>
                <option value="category" {{ old('target_type') == 'category' ? 'selected' : '' }}>Category</option>
            </select>
        </div>

        <!-- Target Products - UPDATED with Select2 -->
            ...
            <select name="target_ids[]" 
                ...
                @foreach($products as $product)
                    <option value="{{ $product->id }}" 
                            {{ in_array($product->id, old('target_ids', [])) ? 'selected' : '' }}
        ...
        <!-- Target Categories - UPDATED with Select2 -->
            ...
            <select name="target_ids[]" 
                ...
                @foreach($categories as $category)
                    <option value="{{ $category->id }}" 
                            {{ in_array($category->id, old('target_ids', [])) ? 'selected' : '' }}>
                        {{ $category->name }}
                    </option>
                @endforeach
            </select>
...
<!-- Replace the existing Select2 CSS section with this improved version -->

<!-- Add Select2 CSS (Place in <head> section) -->
...
.select2-results__option .text-gray-500 {
    color: rgb(107 114 128) !important;
...
/* When option is highlighted, adjust nested text colors */
.select2-container--default .select2-results__option--highlighted[aria-selected] .font-medium,
.select2-container--default .select2-results__option--highlighted[aria-selected] .text-gray-500 {
    color: white !important;
}
</style>

<!-- Add Select2 JS (Place before closing </body> tag) -->
