<x-app-layout>
    ...
    <div id="pageLoader" class="fixed inset-0 bg-white dark:bg-gray-900 z-50 flex items-center justify-center">
        <div class="text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">Loading Profit Report Page...</h3>
    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="font-bold text-3xl text-gray-900 dark:text-white">Profit Report</h2>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Comprehensive profit analysis and financial insights</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <form method="GET" action="{{ route('report.profit') }}" id="filterForm" class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <select name="filter_type" id="filterType" 
                                    class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                ...
                <div class="relative bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transition-all duration-300 overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-center text-sm bg-white bg-opacity-10 backdrop-blur-sm rounded-lg px-3 py-1.5 w-fit">
                            ...
                            <span>{{ number_format($statistics['total_transactions']) }} transactions</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Total Profit -->
                <div class="relative bg-gradient-to-br from-green-500 via-green-600 to-emerald-700 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transition-all duration-300 overflow-hidden group">
                    <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-4">
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-3">
                        ...
                        <p class="text-green-100 text-sm font-medium mb-1">Total Profit</p>
                        <h3 class="text-4xl font-bold mb-3">Rp {{ number_format($statistics['total_profit'], 0, ',', '.') }}</h3>
                        <div class="flex items-center text-sm bg-white bg-opacity-10 backdrop-blur-sm rounded-lg px-3 py-1.5 w-fit">
                            <svg class="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <!-- Profit Margin -->
                <div class="relative bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-600 rounded-2xl shadow-lg hover:shadow-xl p-6 text-white transition-all duration-300 overflow-hidden group">
                    <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-4">
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-3">
                        ...
                        <h3 class="text-4xl font-bold mb-3">{{ number_format($statistics['profit_margin'], 2) }}%</h3>
                        <div class="flex items-center text-sm bg-white bg-opacity-10 backdrop-blur-sm rounded-lg px-3 py-1.5 w-fit">
                            <svg class="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm">Avg Profit/Transaction</p>
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                Rp {{ number_format($statistics['average_profit_per_transaction'], 0, ',', '.') }}
                            </h4>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm">Total Discount Given</p>
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                Rp {{ number_format($statistics['total_discount_given'], 0, ',', '.') }}
                            </h4>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 dark:text-gray-400 text-sm">Total Tax Collected</p>
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                Rp {{ number_format($statistics['total_tax_collected'], 0, ',', '.') }}
                            </h4>
                        </div>
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center p-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-700 rounded-xl hover:shadow-md transition-all duration-200 group">
                            <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center text-white font-bold mr-4">
                                {{ $index + 1 }}
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 dark:text-gray-100 truncate group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                                ...
                                <div class="flex items-center gap-4 mt-1">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                        {{ $product->profit_margin >= 30 ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 
                                           ($product->profit_margin >= 15 ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' : 
                ...
                <div class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-700 dark:to-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select id="items-per-page" class="px-7 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:text-white text-sm">
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 dark:bg-gray-700/50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Cost</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Profit</th>
                                <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Margin</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($profits as $sale)
                                @php
                                    $totalCost = 0;
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center text-white font-bold mr-3">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                {{ $sale->saleDetails->sum('quantity') }} qty
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                        {{ $profitMargin >= 30 ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 
                                           ($profitMargin >= 15 ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' : 
                                           'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400') }}">
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400 text-lg font-semibold mb-1">No transaction data found</p>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/30 px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div class="text-sm text-gray-600 dark:text-gray-400">
                            Showing <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $profits->firstItem() }}</span> 
                            to <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $profits->lastItem() }}</span> 
                            of <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $profits->total() }}</span> results
                        </div>
                        
                        <div class="flex items-center gap-2">
                            @if ($profits->onFirstPage())
                            ...
                            @else
                                <a href="{{ $profits->previousPageUrl() }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm transition-colors duration-200">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                                    </svg>
                                </a>
                            ...
                            <div class="hidden sm:flex items-center gap-1">
                                @foreach ($profits->getUrlRange(1, $profits->lastPage()) as $page => $url)
                                    @if ($page == $profits->currentPage())
                                        <span class="px-4 py-2 text-sm font-bold text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg shadow-md">
                                            {{ $page }}
                                        </span>
                                    @elseif ($page == 1 || $page == $profits->lastPage() || abs($page - $profits->currentPage()) < 3)
                                    ...
                                    @elseif (abs($page - $profits->currentPage()) == 3)
                            ...
                            <div class="sm:hidden px-4 py-2 text-sm font-semibold text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg">
                                {{ $profits->currentPage() }} / {{ $profits->lastPage() }}
                            </div>

                            @if ($profits->hasMorePages())
                                <a href="{{ $profits->nextPageUrl() }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm transition-colors duration-200">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            console.log('✅ Profit Report Scripts Loaded');
            ...
            document.getElementById('exportPdfBtn')?.addEventListener('click', function() {
                ...
                window.location.href = '{{ route("report.profit-pdf") }}?' + params.toString();
            ...
            document.getElementById('exportExcelBtn')?.addEventListener('click', function() {
                ...
                const params = new URLSearchParams(new FormData(document.getElementById('filterForm')));
                window.location.href = '{{ route("report.profit-excel") }}?' + params.toString();
