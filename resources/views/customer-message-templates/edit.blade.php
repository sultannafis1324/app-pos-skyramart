        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Customize your {{ $template->type }} welcome message template
                </p>
            </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form method="POST" action="{{ route('customer-message-templates.update', $template->id) }}" id="templateForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="greeting_text" rows="3" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white font-mono text-sm">{{ old('greeting_text', $template->greeting_text) }}</textarea>
                                    @error('greeting_text')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="account_details_title" 
                                           value="{{ old('account_details_title', $template->account_details_title) }}"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white font-mono text-sm">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="benefits_title" 
                                           value="{{ old('benefits_title', $template->benefits_title) }}"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white font-mono text-sm">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="benefits_list" rows="6" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white font-mono text-sm">{{ old('benefits_list', $template->benefits_list) }}</textarea>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="contact_info" rows="4" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white font-mono text-sm">{{ old('contact_info', $template->contact_info) }}</textarea>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="footer_text" rows="3" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-white font-mono text-sm">{{ old('footer_text', $template->footer_text) }}</textarea>
                                </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-2 max-h-96 overflow-y-auto">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition" 
                                    ...
                                    <div class="flex items-center justify-between">
                                        <code class="text-xs font-mono text-purple-600 dark:text-purple-400">{{ $var }}</code>
    ...
    <script>
        ...
        function resetToDefault() {
            if (confirm('Are you sure you want to reset this template to default? All your changes will be lost.')) {
                ...
                form.method = 'POST';
                form.action = '{{ route('customer-message-templates.reset', $template->id) }}';
