        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('Point of Sale - Cashier')); ?>
                                        ...
                                        <div class="w-full sm:w-56">
                                            <select id="categoryFilter" onchange="searchProducts()"
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?>n
                                                    </option>
...
<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="border-2 border-gray-200 dark:border-gray-600 rounded-xl p-3 lg:p-4 cursor-pointer hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-500 product-card transition-all duration-300 <?php echo e($product->stock <= 0 ? 'opacity-50 cursor-not-allowed' : 'hover:-translate-y-1'); ?> bg-white dark:bg-gray-800 relative"
        onclick="<?php echo e($product->stock > 0 ? 
            "addProduct(
                '{$product->id}', 
        ...
        data-minimum-stock="<?php echo e($product->minimum_stock); ?>"
        
        data-product-name="<?php echo e(addslashes($product->product_name)); ?>"
        data-final-price="<?php echo e($finalPrice); ?>"
        data-original-price="<?php echo e($originalPrice); ?>"
        data-price-promo-id="<?php echo e($pricePromotion ? $pricePromotion->id : ''); ?>"
        data-price-discount="<?php echo e($priceDiscount); ?>"
        data-price-promo-type="<?php echo e($pricePromotion ? $pricePromotion->type : ''); ?>"
        data-qty-promo-id="<?php echo e($quantityPromotion ? $quantityPromotion->id : ''); ?>"
        data-buy-qty="<?php echo e($quantityPromotion ? $quantityPromotion->buy_quantity : 0); ?>"
        data-get-qty="<?php echo e($quantityPromotion ? $quantityPromotion->get_quantity : 0); ?>"
        data-qty-promo-type="<?php echo e($quantityPromotion ? $quantityPromotion->type : ''); ?>">
        
        
        <?php if($hasPromotion): ?>
            <div class="absolute top-1 right-1 z-10 flex flex-col gap-1">
                <?php if($pricePromotion): ?>
                    <span class="inline-block text-xs font-bold px-2 py-1 rounded-full text-white shadow-lg animate-pulse" 
                          style="background-color: <?php echo e($pricePromotion->badge_color ?? '#FF0000'); ?>;">
                        <?php echo e($pricePromotion->badge_text); ?>

                    </span>
                <?php endif; ?>
                <?php if($quantityPromotion): ?>
                    <span class="inline-block text-xs font-bold px-2 py-1 rounded-full text-white shadow-lg animate-pulse" 
                          style="background-color: <?php echo e($quantityPromotion->badge_color ?? '#00AA00'); ?>;">
                        <?php echo e($quantityPromotion->badge_text); ?>
        ...
        <div class="flex flex-col space-y-3">
            ...
            <div class="space-y-1">
                        ...
                        <div class="flex flex-col">
                            <?php if($pricePromotion): ?>
                                ...
                                <span class="text-xs text-green-600">
                                    Hemat Rp <?php echo e(number_format($priceDiscount, 0, ',', '.')); ?>
                            ...
                            <?php if($quantityPromotion): ?>
                                <span class="text-xs text-purple-600 font-bold mt-1">
                                    Beli <?php echo e($quantityPromotion->buy_quantity); ?> Gratis <?php echo e($quantityPromotion->get_quantity); ?>!
                                </span>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                ...
                <div class="status-container">
                    ...
                    <?php elseif($product->stock <= $product->minimum_stock): ?>
                        <div class="text-center mt-2">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200">
                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                </svg>
                                Low Stock (Min: <?php echo e($product->minimum_stock); ?>)
                            </span>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div id="customerList">
                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="customer-item p-3 border-b border-gray-200 dark:border-gray-600 cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-600 transition-colors duration-150"
                        onclick="selectCustomer('<?php echo e($customer->id); ?>', '<?php echo e(addslashes($customer->customer_name)); ?>', '<?php echo e($customer->phone_number); ?>', '<?php echo e($customer->photo_profile ? asset('storage/' . $customer->photo_profile) : ''); ?>', '<?php echo e($customer->loyalty_points); ?>')">
                        <div class="flex items-center space-x-3">
                            <?php if($customer->photo_profile): ?>
                                <img src="<?php echo e(asset('storage/' . $customer->photo_profile)); ?>"
                                    alt="<?php echo e($customer->customer_name); ?>"
                            ...
                            <?php else: ?>
                                <div
                                    ...
                                    <span
                                        class="text-white font-semibold text-sm"><?php echo e(substr($customer->customer_name, 0, 1)); ?></span>
                                </div>
                            <?php endif; ?>
                            <div class="flex-1">
                                <div
                                ...
                                <div
                                    ...
                                    <?php echo e($customer->phone_number); ?></div>
                                <div
                                    class="text-xs text-blue-600 dark:text-blue-400 font-medium">
                                    <?php echo e($customer->loyalty_points); ?> points</div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div id="customerInfo"
    ...
    <!-- ✅ REMOVED: payment_channel hidden input - Snap will handle it -->
                        ...
                        <input type="hidden" name="transaction_number"
                            value="<?php echo e('TXN-' . date('YmdHis') . '-' . rand(1000, 9999)); ?>">
                        <input type="hidden" name="sale_date" value="<?php echo e(now()); ?>">
...
<?php if($paymentSuccess === 'true' && $saleId && $transactionNumber): ?>
            ...
            <div id="successState" class="hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-center text-gray-600 dark:text-gray-400 mb-6">
                        Transaction: <span class="font-semibold text-green-600"><?php echo e($transactionNumber); ?></span>
                    </p>

                    <div class="space-y-3">
                        <a href="<?php echo e(route('sales.show', $saleId)); ?>"
                        ...
                        <button onclick="printReceiptFromModal(<?php echo e($saleId); ?>)"
            ...
            <div id="pendingState" class="hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-center text-gray-600 dark:text-gray-400 mb-4">
                        Transaction: <span class="font-semibold text-blue-600"><?php echo e($transactionNumber); ?></span>
                    </p>
                    ...
                    <div class="space-y-3">
                        <button type="button" onclick="checkPaymentStatusFromModal(<?php echo e($saleId); ?>)" id="checkStatusBtnModal"
                            class="w-full flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-lg transition-all shadow-md">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const saleId = <?php echo e($saleId); ?>;
...
<?php if(session('show_cancel_modal')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const modalData = <?php echo json_encode(session('show_cancel_modal'), 15, 512) ?>;
...
let availableProducts = <?php echo json_encode($products, 15, 512) ?>;
let allCustomers = <?php echo json_encode($customers, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH C:\laragon\www\app-pos-skyramart\resources\views/sales/create.blade.php ENDPATH**/ ?>