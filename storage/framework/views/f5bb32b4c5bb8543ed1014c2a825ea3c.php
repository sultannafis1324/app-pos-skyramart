        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('Store Variables Preview')); ?>
            ...
            <a href="<?php echo e(route('store-settings.index')); ?>" 
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-indigo-50 dark:bg-indigo-900 rounded-lg p-4">
                                ...
                                <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-300"><?php echo e($settings->store_name); ?></p>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 dark:text-gray-100"><?php echo e($settings->store_address); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 dark:text-gray-100"><?php echo e($settings->store_email); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 dark:text-gray-100"><?php echo e($settings->store_phone); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 dark:text-gray-100"><?php echo e($settings->store_whatsapp); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 dark:text-gray-100"><?php echo e($settings->store_hours); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-2 gap-3 text-sm">
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100 font-mono"><?php echo e($settings->currency_symbol); ?> (<?php echo e($settings->currency_code); ?>)</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Timezone</p>
                                        <p class="text-gray-900 dark:text-gray-100"><?php echo e($settings->timezone); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-gray-600 transition cursor-pointer"
                                 onclick="copyToClipboard('<?php echo e($key); ?>')">
                                <div class="flex items-center justify-between mb-2">
                                    <code class="text-sm font-mono text-purple-600 dark:text-purple-400"><?php echo e($key); ?></code>
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                                    </svg>
                                </div>
                                <p class="text-sm text-gray-700 dark:text-gray-300 break-all"><?php echo e($value); ?></p>
                            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\app-pos-skyramart\resources\views/store-settings/preview.blade.php ENDPATH**/ ?>