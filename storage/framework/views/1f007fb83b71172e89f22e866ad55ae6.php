     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="<?php echo e(route('receipt-templates.edit', $template->id)); ?>" 
                        ...
                        <div class="p-6">
                            ...
                            <div class="bg-gradient-to-b from-green-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-lg p-4 border-2 border-green-200 dark:border-green-700">
                                <div class="bg-white dark:bg-gray-900 rounded-lg p-4 shadow-md">
                                    <div class="space-y-3 text-sm font-mono whitespace-pre-wrap">
                                        ...
                                        <?php if($preview['items_title']): ?>
                                        <div class="border-t border-gray-300 dark:border-gray-600 pt-2 mt-2">
                                            <div class="font-semibold text-gray-900 dark:text-gray-100">
                                                <?php echo nl2br(e($preview['items_title'])); ?>
                                        ...
                                        <?php if($preview['payment_title']): ?>
                                        <div class="border-t border-gray-300 dark:border-gray-600 pt-2 mt-2">
                                            <div class="font-semibold text-gray-900 dark:text-gray-100">
                                                <?php echo nl2br(e($preview['payment_title'])); ?>
                                        ...
                                        <div class="border-t border-gray-300 dark:border-gray-600 pt-2 mt-2 text-center font-semibold text-gray-900 dark:text-gray-100 text-xs">
                                            <?php echo e($template->store_branding ?? '💚 SkyraMart - Your Trusted Store'); ?>
                            ...
                            <div class="bg-white rounded-lg p-6 shadow-md border-2 border-gray-300" style="font-family: 'Courier New', monospace; font-size: 12px;">
                                <div class="text-center border-b-2 border-black pb-4 mb-4">
                                    <?php if($preview['header']): ?>
                                    <div class="font-bold" style="white-space: pre-wrap;"><?php echo e($preview['header']); ?></div>
                                    <?php endif; ?>
                                </div>

                                <?php if($preview['transaction_title']): ?>
                                <div class="font-bold mb-2"><?php echo e($preview['transaction_title']); ?></div>
                                <?php endif; ?>
                                ...
                                <?php if($preview['items_title']): ?>
                                <div class="font-bold border-t-2 border-black pt-2 mt-2 mb-2"><?php echo e($preview['items_title']); ?></div>
                                <?php endif; ?>
                                ...
                                <?php if($preview['payment_title']): ?>
                                <div class="font-bold border-t-2 border-black pt-2 mt-2 mb-2"><?php echo e($preview['payment_title']); ?></div>
                                <?php endif; ?>
                                ...
                                <table class="w-full text-sm">
                                    <tbody class="space-y-2">
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            ...
                                            <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($sampleData['customer_name']); ?></td>
                                        </tr>
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Transaction No:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100 font-mono text-xs"><?php echo e($sampleData['transaction_number']); ?></td>
                                        </tr>
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Date:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($sampleData['date']); ?> <?php echo e($sampleData['time']); ?></td>
                                        </tr>
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Cashier:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($sampleData['cashier_name']); ?></td>
                                        </tr>
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Subtotal:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($sampleData['subtotal'], 0, ',', '.')); ?></td>
                                        </tr>
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Discount:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($sampleData['discount'], 0, ',', '.')); ?> (<?php echo e($sampleData['discount_percentage']); ?>%)</td>
                                        </tr>
                                        <tr class="border-b border-gray-200 dark:border-gray-600">
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Total:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100 font-bold">Rp <?php echo e(number_format($sampleData['total'], 0, ',', '.')); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="py-2 font-medium text-gray-700 dark:text-gray-300">Payment:</td>
                                            <td class="py-2 text-gray-900 dark:text-gray-100"><?php echo e($sampleData['payment_method']); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\app-pos-skyramart\resources\views/receipt-templates/preview.blade.php ENDPATH**/ ?>