        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Customize your <?php echo e($template->type); ?> receipt template
                </p>
            </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form method="POST" action="<?php echo e(route('receipt-templates.update', $template->id)); ?>" id="templateForm">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="header_text" rows="3" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm"><?php echo e(old('header_text', $template->header_text)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="greeting_text" rows="2" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm"><?php echo e(old('greeting_text', $template->greeting_text)); ?></textarea>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="transaction_section_title" 
                                           value="<?php echo e(old('transaction_section_title', $template->transaction_section_title)); ?>"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="items_section_title" 
                                           value="<?php echo e(old('items_section_title', $template->items_section_title)); ?>"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="payment_section_title" 
                                           value="<?php echo e(old('payment_section_title', $template->payment_section_title)); ?>"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="notes_text" rows="2" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm"><?php echo e(old('notes_text', $template->notes_text)); ?></textarea>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="contact_info" rows="3" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm"><?php echo e(old('contact_info', $template->contact_info)); ?></textarea>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="footer_text" rows="3" 
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm"><?php echo e(old('footer_text', $template->footer_text)); ?></textarea>
                                </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-2 max-h-96 overflow-y-auto">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition" 
                                    ...
                                    <div class="flex items-center justify-between">
                                        <code class="text-xs font-mono text-blue-600 dark:text-blue-400"><?php echo e($var); ?></code>
    ...
    <script>
        ...
        function resetToDefault() {
            if (confirm('Are you sure you want to reset this template to default? All your changes will be lost.')) {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(route('receipt-templates.reset', $template->id)); ?>';
...
<?php endif; ?><?php /**PATH C:\laragon\www\app-pos-skyramart\resources\views/receipt-templates/edit.blade.php ENDPATH**/ ?>